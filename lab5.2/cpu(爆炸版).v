...
module mycpu(
	...
	begin
        ...
        else if(forward_wait5_r1_reg == 1'b1 && pipe1_allowin )
        begin
            forward_wait5_r1_reg <= 1'b0;
        end
        else if(forward_wait5_r1_reg == 1'b1)
        begin
            forward_wait5_r1_reg <= forward_wait5_r1_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_wait5_r2_reg == 1'b1 && pipe1_allowin )
        begin
            forward_wait5_r2_reg <= 1'b0;
        end
        else if(forward_wait5_r2_reg == 1'b1)
        begin
            forward_wait5_r2_reg <= forward_wait5_r2_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forwarding_reg == 1'b1 && pipe1_allowin )
        begin
            forwarding_reg <= 1'b0;
        end
        else if(forwarding_reg == 1'b1)
        begin
            forwarding_reg <= forwarding_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_mfhi_reg == 1'b1 && pipe1_allowin )
        begin
            forward_mfhi_reg <= 1'b0;
        end
        else if(forward_mfhi_reg == 1'b1)
        begin
            forward_mfhi_reg <= forward_mfhi_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_mflo_reg == 1'b1 && pipe1_allowin)
        begin
            forward_mflo_reg <= 1'b0;
        end
        else if(forward_mfhi_reg == 1'b1)
        begin
            forward_mflo_reg <= forward_mflo_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_pipe3_r1_reg == 1'b1 && pipe1_allowin)
        begin
            forward_pipe3_r1_reg <= 1'b0;
        end
        else if(forward_pipe3_r1_reg == 1'b1)
        begin
            forward_pipe3_r1_reg <= forward_pipe3_r1_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_pipe3_r2_reg == 1'b1 && pipe1_allowin)
        begin
            forward_pipe3_r2_reg <= 1'b0;
        end
        else if(forward_pipe3_r2_reg == 1'b1)
        begin
            forward_pipe3_r2_reg <= forward_pipe3_r2_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_pipe4_r1_reg == 1'b1 && pipe1_allowin)
        begin
            forward_pipe4_r1_reg <= 1'b0;
        end
        else if(forward_pipe4_r1_reg == 1'b1)
        begin
            forward_pipe4_r1_reg <= forward_pipe4_r1_reg;
        end
		else
		begin
	...
	begin
        ...
        else if(forward_pipe4_r2_reg == 1'b1 && pipe1_allowin )
        begin
            forward_pipe4_r2_reg <= 1'b0;
        end
        else if(forward_pipe4_r2_reg == 1'b1)
        begin
            forward_pipe4_r2_reg <= forward_pipe4_r2_reg;
        end
		else
		begin
	...
	assign rdata1_input = (forwarding_reg == 2'd0) ? rdata1 :
						  (forward_pipe3_r1_reg ) ? choose_data3 :
						  (forward_pipe4_r1_reg ) ? wdata :
						  (forward_wait5_r1_reg ) ? ALU_out5 :
						  rdata1;
	assign rdata2_input = (forwarding_reg == 2'd0) ? rdata2 :
