...
module mycpu_top(
	...
	assign pipe2_readyout = !counter_forwarding && !counter_lw_choke && (!counter_div_choke)&& (!(op_div_reg == 1'b1 && op_div_last_reg ==1'b0) || syscall_info3) && (!(op_mul_reg == 1'b1 && op_mul_last_reg ==1'b0)|| syscall_info3);
