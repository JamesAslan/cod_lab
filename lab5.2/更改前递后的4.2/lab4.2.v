...
module mycpu_top(
	...
	assign PC = ((irp_ip2_3 || irp_ip3_3 || irp_ip4_3 || irp_ip5_3 || irp_ip6_3 || irp_ip7_3 || irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid) ? 32'hbfc00380 :
				(branch_or_not && pipe2_valid && counter_branch) ? (pipe1_PC + Shift_left2_reg) :
	...
	begin
		...
		else if (branch_or_not && pipe2_valid && pipe1_allowin && counter_branch && !counter_lw_choke) ////////////////?????????????????????!!!!!!!!!!!!!!!!!!!!
		begin
			PC_reg <= pipe1_PC + Shift_left2_reg +32'd4;
		end
		else if (branch_or_not && pipe2_valid && counter_branch &&!counter_lw_choke) ////////////////?????????????????????!!!!!!!!!!!!!!!!!!!!
		begin
...
assign Write_data =		({32{mem_sb}} & sb_data) |
	...
	assign LO_wen = (op_mul_reg && counter_mul_choke && pipe2_valid) || (mtlo_reg && !(irp_ip2_3 || irp_ip3_3 || irp_ip4_3 || irp_ip5_3 || irp_ip6_3 || irp_ip7_3 || irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)) || (op_div_reg && div_complete && pipe2_valid);
	assign HI_wen = (op_mul_reg && counter_mul_choke && pipe2_valid) || (mthi_reg && !(irp_ip2_3 || irp_ip3_3 || irp_ip4_3 || irp_ip5_3 || irp_ip6_3 || irp_ip7_3 || irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)) || (op_div_reg && div_complete && pipe2_valid);
	...
	assign div_choke_input = div_history; //&& (forward_pipe3_r1_reg || forward_pipe4_r1_reg || forward_wait5_r1_reg || forward_pipe3_r2_reg || forward_pipe4_r2_reg || forward_wait5_r2_reg);
