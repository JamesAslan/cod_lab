...
module mycpu_top(
	...
	assign op_add = (inst_op == 6'b0 && inst_constent == `ADDU ) |
					...
					(inst_op == 6'b0 && inst_constent == `SYSCALL) |
					(inst_op == `ADDIU) |
					(inst_op == `ADDI) |
					(inst_op == `LW   ) |
					(inst_op == `LB   ) |
	...
	assign forward_pipe3_r2 = (((raddr2 == waddr_dst2) && (raddr2 != 5'b0)) ? 1'b1:1'b0) && ((pipe2_data[31:26] != `LW) || (pipe2_data[31:26] != `LB) || (pipe2_data[31:26] != `LBU) || (pipe2_data[31:26] != `LH) || (pipe2_data[31:26] != `LHU) || (pipe2_data[31:26] != `LWL) || (pipe2_data[31:26] != `LWR)) && (((inst_op == 6'b010000) && (inst_ad1 == `MTC0) && (pipe2_data_in[10:3] == 8'b0)) || (pipe2_data_in[31:26] == 6'b0) || (pipe2_data_in[31:26] == `BEQ) || (pipe2_data_in[31:26] == `BNE) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZ) || (pipe2_data_in[31:26] == `BLEZ && pipe2_data_in[20:16] == 5'b0) || (pipe2_data_in[31:26] == `BGTZ && pipe2_data_in[20:16] == 5'b0) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZ) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZAL) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZAL) || (pipe2_data_in[31:26] == `SW) || (pipe2_data_in[31:26] == `SB) || (pipe2_data_in[31:26] == `SH) || (pipe2_data_in[31:26] == `SWL) || (pipe2_data_in[31:26] == `SWR)) && reg_write2 && !counter_forwarding;
	...
	assign forward_pipe4_r2 = (((raddr2 == waddr_dst3) && (raddr2 != 5'b0)) ? 1'b1:1'b0) && (((inst_op == 6'b010000) && (inst_ad1 == `MTC0) && (pipe2_data_in[10:3] == 8'b0)) || (pipe2_data_in[31:26] == 6'b0) || (pipe2_data_in[31:26] == `BEQ) || (pipe2_data_in[31:26] == `BNE) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZ) || (pipe2_data_in[31:26] == `BLEZ && pipe2_data_in[20:16] == 5'b0) || (pipe2_data_in[31:26] == `BGTZ && pipe2_data_in[20:16] == 5'b0) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZ) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZAL) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZAL) || (pipe2_data_in[31:26] == `SW) || (pipe2_data_in[31:26] == `SB) || (pipe2_data_in[31:26] == `SH) || (pipe2_data_in[31:26] == `SWL) || (pipe2_data_in[31:26] == `SWR)) && reg_write3 && !counter_forwarding;
	...
	assign forward_wait5_r2 = (((raddr2 == waddr_dst4) && (raddr2 != 5'b0)) ? 1'b1:1'b0) && (((inst_op == 6'b010000) && (inst_ad1 == `MTC0) && (pipe2_data_in[10:3] == 8'b0)) || (pipe2_data_in[31:26] == 6'b0) || (pipe2_data_in[31:26] == `BEQ) || (pipe2_data_in[31:26] == `BNE) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZ) || (pipe2_data_in[31:26] == `BLEZ && pipe2_data_in[20:16] == 5'b0) || (pipe2_data_in[31:26] == `BGTZ && pipe2_data_in[20:16] == 5'b0) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZ) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZAL) || (pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZAL) || (pipe2_data_in[31:26] == `SW) || (pipe2_data_in[31:26] == `SB) || (pipe2_data_in[31:26] == `SH) || (pipe2_data_in[31:26] == `SWL) || (pipe2_data_in[31:26] == `SWR)) && reg_write4 && !counter_forwarding;
	...
	assign choose_data3  = 	({32{memtoreg3 == 3'b001}} & ALU_out3) |
								({32{memtoreg3 == 3'b000}} & ALU_out3) |
								({32{memtoreg3 == 3'b010}} & HI) |
								({32{memtoreg3 == 3'b011}} & LO) |
								({32{memtoreg3 == 3'd4}} & cp0_read_data);
	...
	assign cp0_read = (inst_op == 6'b010000) && (inst_ad1 == `MFC0) && (pipe2_data_in[10:3] == 8'b0);
	assign cp0_wen = (inst_op == 6'b010000) && (inst_ad1 == `MTC0) && (pipe2_data_in[10:3] == 8'b0);

	assign cp0_destination = {inst_ad3,inst_sel};
	assign cp0_read_data = 	({32{cp0_destination3 == 8'b01110000}} & cp0_epc) |
							({32{cp0_destination3 == 8'b01101000}} & cp0_cause) |
							({32{cp0_destination3 == 8'b01100000}} & cp0_status);
	assign cp0_wen_epc = cp0_wen && (cp0_destination == 8'b01110000);
	assign cp0_wen_status = cp0_wen && (cp0_destination == 8'b01100000);
	assign cp0_wen_cause = cp0_wen && (cp0_destination == 8'b01101000);
	assign cp0_write_data = rdata2_reg;

	reg[31:0] cp0_write_data_reg;
	always @(posedge clk)
	begin
		if(rst)
		begin
			cp0_write_data_reg	<=	32'b0;
		end
		else 
		begin
			cp0_write_data_reg	<=	cp0_write_data;
		end
	end
	...
	// interupt-related
	wire interupt_info;
	assign interupt_info =  (inst_op == 6'b0 && inst_constent == `SYSCALL) ? 1'b1:1'b0;

	wire eret;
	assign eret= (inst_op == 6'b010000) && (pipe2_data_in[25] == 1'b1) && (pipe2_data_in[24:6] == 19'b0) &&(inst_constent == `ERET);
	...
	reg[2:0] memtoreg4;
	wire[2:0] memtoreg;
	assign memtoreg = 	(cp0_read == 1'b1) ? 3'd4:
						(inst_op == 6'b0 && inst_constent == `MFHI && pipe2_data_in[25:16]==10'b0 && pipe2_data_in[10:6]==5'b0) ? 3'b010 :
						(inst_op == 6'b0 && inst_constent == `MFLO && pipe2_data_in[25:16]==10'b0 && pipe2_data_in[10:6]==5'b0) ? 3'b011 :
						(inst_op == `LW || inst_op == `LB || inst_op == `LBU || inst_op == `LH || inst_op == `LHU || inst_op == `LWL || inst_op == `LWR) ? 3'b001 : 3'b000;
	...
	assign PC = ({32{interupt_info3}} & 32'hbfc00380) |
				({32{eret && pipe2_valid && !counter_forwarding && !interupt_info3}} & cp0_epc) |
				({32{branch_or_not && pipe2_valid && !counter_forwarding && !interupt_info3}} & (pipe1_PC + Shift_left2_reg)) |
				({32{jump_or_not && pipe2_valid && !counter_forwarding && !interupt_info3}} & (jump_target)) |
	 			({32{!PC_change}} & PC_reg);
	...
	begin
		...
		else if (eret && pipe2_valid && !counter_forwarding && !counter_lw_choke)
		begin
			PC_reg <= cp0_epc;
		end
	...
	assign PC_change = (jump_or_not || branch_or_not ||eret ||interupt_info3) && pipe2_valid && (!counter_forwarding) && (!counter_lw_choke);//&& (!eret) && (!interupt_info3);
