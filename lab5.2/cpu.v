...
module mycpu(
	...
	assign inst_sram_en = inst_state[0] && resetn;
	...
	begin
        ...
        //else if((inst_state == 3'b110) && (inst_sram_data_ok))
        //begin
        //    inst_state <= 3'b000;
        //end
	end
	...
	assign pipe1_readyout = (inst_state == 3'b000);
	...
	begin
		...
		else if((irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3 || ((pipe2_data_in[31:26] == 6'b010000) && (pipe2_data_in[25] == 1'b1) && (pipe2_data_in[24:6] == 19'b0) &&(pipe2_data_in[5:0] == `ERET))) && pipe3_valid)
		begin
			pipe1_valid <= 1'b0;
		end
		...
		else if((validin && pipe1_allowin) || (pipe1_allowin != !counter_choke) )//|| inst_sram_data_ok)//////////////////////////////????????????????????//
		begin
	...
	assign pipe2_readyout = !counter_forwarding[0] && !counter_lw_choke && (!counter_div_choke)&& (!(op_div_reg == 1'b1 && op_div_last_reg ==1'b0) || syscall_info3) && (!(op_mul_reg == 1'b1 && op_mul_last_reg ==1'b0)|| syscall_info3);
	...
	begin
		...
		else if((irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid)
		begin
			pipe2_valid <= 1'b0;
		end
		...
		begin
			...
			mthi_reg <= 1'b0;
			mtlo_reg <= 1'b0;
			forward_pipe3_r1_index2 <= 1'b0;
			forward_pipe3_r2_index2 <= 1'b0;
			forward_pipe4_r1_index2 <= 1'b0;
			forward_pipe4_r2_index2 <= 1'b0;
			forward_wait5_r1_index2 <= 1'b0;
			forward_wait5_r2_index2 <= 1'b0;
		end
		...
		begin
			...
			op_mul_reg <= (op_mul && !(irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3));
			mul_signed_reg <= mul_signed;
			op_div_reg <= (op_div && !(irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3));//////////////////////////////////////////////?????????????????????????????????????
			...
			mthi_reg <= mthi;
			mtlo_reg <= mtlo;
			forward_pipe3_r1_index2 <= forward_pipe3_r1_index;
			forward_pipe3_r2_index2 <= forward_pipe3_r2_index;
			forward_pipe4_r1_index2 <= forward_pipe4_r1_index;
			forward_pipe4_r2_index2 <= forward_pipe4_r2_index;
			forward_wait5_r1_index2 <= forward_wait5_r1_index;
			forward_wait5_r2_index2 <= forward_wait5_r2_index;
		end
		else
		begin
			slot_or_not_reg2 <= slot_or_not_reg2;
			irp_ip2 <= irp_ip2;
			irp_ip0_2 <= irp_ip0_2;
			irp_ip1_2 <= irp_ip1_2;
			irp_inst2 <= irp_inst2;
			irp_support2 <= irp_support2;
			irp_time2 <= irp_time2;
			break_info2 <= break_info2;
			syscall_info2 <= syscall_info2;
			syscall_in_slot2 <= syscall_in_slot2;
			cp0_wen_epc2 <= cp0_wen_epc2;
			cp0_wen_status2 <= cp0_wen_status2;
			cp0_wen_cause2 <= cp0_wen_cause2;
			cp0_wen_count2 <= cp0_wen_count2;
			cp0_wen_compare2 <= cp0_wen_compare2;
		...
		else if(((pipe1_outvalid && pipe2_allowin) || counter_forwarding) && !counter_lw_choke_reg)
		begin
	...
	assign pipe3_readyout = (MemRead | MemWrite) ? (data_state == 3'b000) : 1'b1;
	...
	begin
		...
		begin
			slot_or_not_reg3 <= slot_or_not_reg3;
			irp_address_sw3 <= irp_address_sw3;
			irp_address_lw3 <= irp_address_lw3;
			irp_inst3 <= irp_inst3;
			irp_ip0_3 <= irp_ip0_3;
			irp_ip1_3 <= irp_ip1_3;
			irp_support3 <= irp_support3;
			irp_time3 <= irp_time3;
			irp_overflow3 <= irp_overflow3;
			break_info3 <= break_info3;
			syscall_info3 <= syscall_info3;
			syscall_in_slot3 <= syscall_in_slot3;
	...
	begin
		...
		else if(irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3)
		begin
			pipe4_valid <= 1'b0;
		end
	...
	//////alu����ָ��
	wire [11:0] aluop_decode;				//alu�Ĳ���ָ��
	...
	assign op_add = (pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[5:0] == `ADDU ) |
					...
					1'd0;
	assign op_lui = ((pipe2_data_in[31:26] == `LUI  && pipe2_data_in[25:21] == 5'b0)) |
					1'd0;
	...
	assign op_or  =	(pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[5:0] == `OR   ) |
					...
					(pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[5:0] == `BREAK) |
					(pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[25:16] == 10'b0 && pipe2_data_in[10:6] == 5'b0 && pipe2_data_in[5:0] == `MFHI) |
					(pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[25:16] == 10'b0 && pipe2_data_in[10:6] == 5'b0 && pipe2_data_in[5:0] == `MFLO) |
					(pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BGEZ) |
					(pipe2_data_in[31:26] == `BLEZ && pipe2_data_in[20:16] == 5'b0) |
					(pipe2_data_in[31:26] == `BGTZ && pipe2_data_in[20:16] == 5'b0) |
					(pipe2_data_in[31:26] == `REGIMM && pipe2_data_in[20:16] == `BLTZ) |
	...
	wire nop;
	assign nop = pipe2_data_in[31:0] == 32'b0 ;

	/*wire [5:0] pipe2_data_in[5:0];
	assign pipe2_data_in[5:0] = pipe2_data_in[5:0]; //��pipe1��ȡ��ָ��

	wire [5:0] pipe2_data_in[31:26];
	assign pipe2_data_in[31:26] = pipe2_data_in[31:26]; //��pipe1��ȡ��ָ��
	...
	//////alu_B������Դѡ��; 00Ϊ�Ĵ�����10Ϊsign_extend��11ΪShift_left2
	wire [1:0] alu_B_mux;
	assign alu_B_mux =  /////////////////////////////////????????????????????????????????!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   always@(posedge clk)
	...
	reg forward_pipe3_r1_index;
	reg forward_pipe3_r2_index;
	reg forward_pipe4_r1_index;
	reg forward_pipe4_r2_index;
	reg forward_wait5_r1_index;
	reg forward_wait5_r2_index;
	reg forward_pipe3_r1_index2;
	reg forward_pipe3_r2_index2;
	reg forward_pipe4_r1_index2;
	reg forward_pipe4_r2_index2;
	reg forward_wait5_r1_index2;
	reg forward_wait5_r2_index2;
 
	always@(posedge clk)
	begin
		if(rst )
		begin
			forward_wait5_r1_index <= 1'b0;
		end
        else if(forward_wait5_r1_index == 1'b1 && pipe1_allowin )
        begin
            forward_wait5_r1_index <= 1'b0;
        end
        else if(forward_wait5_r1_index == 1'b1)
        begin
            forward_wait5_r1_index <= forward_wait5_r1_index;
        end
		else
		begin
			forward_wait5_r1_index <= forward_wait5_r1;
		end
	end
	...
	begin
		if(rst )
		begin
			forward_wait5_r2_index <= 1'b0;
		end
        else if(forward_wait5_r2_index == 1'b1 && pipe1_allowin )
        begin
            forward_wait5_r2_index <= 1'b0;
        end
        else if(forward_wait5_r2_index == 1'b1)
        begin
            forward_wait5_r2_index <= forward_wait5_r2_index;
        end
		else
		begin
			forward_wait5_r2_index <= forward_wait5_r2;
		end
	end
	...
	begin
		if(rst )
		begin
			forward_pipe3_r1_index <= 1'b0;
		end
        else if(forward_pipe3_r1_index == 1'b1 && pipe1_allowin)
        begin
            forward_pipe3_r1_index <= 1'b0;
        end
        else if(forward_pipe3_r1_index == 1'b1)
        begin
            forward_pipe3_r1_index <= forward_pipe3_r1_index;
        end
		else
		begin
			forward_pipe3_r1_index <= forward_pipe3_r1;
		end
	end
	...
	begin
		if(rst )
		begin
			forward_pipe3_r2_index <= 1'b0;
		end
        else if(forward_pipe3_r2_index == 1'b1 && pipe1_allowin)
        begin
            forward_pipe3_r2_index <= 1'b0;
        end
        else if(forward_pipe3_r2_index == 1'b1)
        begin
            forward_pipe3_r2_index <= forward_pipe3_r2_index;
        end
		else
		begin
			forward_pipe3_r2_index <= forward_pipe3_r2;
		end
	end
	...
	begin
		if(rst )
		begin
			forward_pipe4_r1_index <= 1'b0;
		end
        else if(forward_pipe4_r1_index == 1'b1 && pipe1_allowin)
        begin
            forward_pipe4_r1_index <= 1'b0;
        end
        else if(forward_pipe4_r1_index == 1'b1)
        begin
            forward_pipe4_r1_index <= forward_pipe4_r1_reg;
        end
		else
		begin
			forward_pipe4_r1_index <= forward_pipe4_r1;
		end
	end
	...
	begin
		if(rst )
		begin
			forward_pipe4_r2_index <= 1'b0;
		end
        else if(forward_pipe4_r2_index == 1'b1 && pipe1_allowin )
        begin
            forward_pipe4_r2_index <= 1'b0;
        end
        else if(forward_pipe4_r2_index == 1'b1)
        begin
            forward_pipe4_r2_index <= forward_pipe4_r2_index;
        end
		else
		begin
			forward_pipe4_r2_index <= forward_pipe4_r2;
		end
	end

	reg lw_choke_r1_index;
	reg lw_choke_r2_index;
	always@(posedge clk)
	begin
		if(rst )
		begin
			lw_choke_r1_index <= 1'b0;
		end
        else if(lw_choke_r1_index == 1'b1 && pipe1_allowin )
        begin
            lw_choke_r1_index <= 1'b0;
        end
        else if(lw_choke_r1_index == 1'b1)
        begin
            lw_choke_r1_index <= lw_choke_r1_index;
        end
		else
		begin
			lw_choke_r1_index <= lw_choke_r1;
		end
	end
	...
	begin
		if(rst )
		begin
			lw_choke_r2_index <= 1'b0;
		end
        else if(lw_choke_r2_index == 1'b1 && pipe1_allowin )
        begin
            lw_choke_r2_index <= 1'b0;
        end
        else if(lw_choke_r2_index == 1'b1)
        begin
            lw_choke_r2_index <= lw_choke_r2_index;
        end
		else
		begin
	...
	assign rdata1_input = (counter_forwarding == 2'd0) ? rdata1 :
						  (forward_pipe3_r1_reg ) ? choose_data3 :
						  (forward_pipe4_r1_reg ) ? wdata :
						  (forward_wait5_r1_reg ) ? ALU_out5 :
						  rdata1;
	assign rdata2_input = (counter_forwarding == 2'd0) ? rdata2 :
	...
	begin
		if(rst )
		begin
			counter_lw_choke_reg <= 1'b0;
		end
		else if(counter_lw_choke == 2'd1)
		begin
			counter_lw_choke_reg <= 1'b1;
		end
		else if(counter_lw_choke == 2'd0)
		begin
			counter_lw_choke_reg <= 2'b0;
		end
	end
	...
	assign cp0_wen_compare = cp0_wen && (pipe2_data_in[15:11] == 8'b01011);
	assign cp0_wen_count = cp0_wen && (pipe2_data_in[15:11] == 8'b01001);
	assign cp0_write_data = (forward_pipe3_r2_reg) ? rdata2_input : rdata2_reg;

	// interupt-related
	wire syscall_info;
	assign syscall_info =  (pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[5:0] == `SYSCALL) ? 1'b1 :  1'b0;
	...
	reg break_info2;
	reg break_info3;
	assign break_info = (pipe2_data_in[31:26] == 6'b0 && pipe2_data_in[5:0] == `BREAK) ? 1'b1 :  1'b0;
	...
	assign alu_A =  ({32{alu_A_mux_reg == 2'b01}} & pipe1_PC ) | 
					...
					({32{alu_A_mux_reg == 2'b00}} & alu_A_input);//rdata1_reg);
	assign alu_B =  (alu_B_mux_reg == 2'b00) ? alu_B_input : //rdata2_reg:
	...
	assign alu_A_input =  (lw_choke_r1_index ) ? rdata1_reg :
						  (forward_pipe3_r1_index2 ) ? choose_data3 :
						  (forward_pipe4_r1_index2 ) ? wdata :
						  (forward_wait5_r1_index2 ) ? ALU_out5 :
						  rdata1_reg;

	assign alu_B_input =  (lw_choke_r2_index ) ? rdata2_reg :
						  (forward_pipe3_r2_index2 ) ? choose_data3 :
						  (forward_pipe4_r2_index2 ) ? wdata :
						  (forward_wait5_r2_index2 ) ? ALU_out5 :
						  rdata2_reg;

						    /*(memtoreg3 == 3'b001) ? ALU_out3 :
							(memtoreg3 == 3'b000) ? ALU_out3 :
							(memtoreg3 == 3'b010) ? HI :
							(memtoreg3 == 3'b011) ? LO :
							(memtoreg3 == 3'd4) ? cp0_read_data;*/ 
	...
	assign PC = ((irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid) ? 32'hbfc00380 :
				(branch_or_not && pipe2_valid && !counter_forwarding) ? (pipe1_PC + Shift_left2_reg) :
				(jump_or_not && pipe2_valid && !counter_forwarding) ? jump_target :
				(eret && pipe2_valid && !counter_forwarding) ? cp0_epc :
	 			PC_reg;
	...
	//assign PC_change = (jump_or_not || branch_or_not ||eret ||syscall_info3) && pipe2_valid && (!counter_forwarding) && (!counter_lw_choke);
	
	wire slot_or_not_reg;
	reg slot_or_not_reg2;
	reg slot_or_not_reg3;
	assign slot_or_not_reg = branch_op || jump_or_not;
	/*always @(posedge clk)
	begin
		if(rst)
		begin 
			slot_or_not_reg <= 1'b0;	
		end
		else if(branch_or_not || jump_or_not)
		begin
			slot_or_not_reg <= 1'b1;
		end
		else if(pipe2_valid)
		begin
			slot_or_not_reg <= 1'b0;
		...
		begin
			slot_or_not_reg <= slot_or_not_reg;
		end		
	end*/
...
assign Write_data =		({32{mem_sb}} & sb_data) |
	...
	assign LO_wen = (op_mul_last_reg && pipe3_valid) || (mtlo_reg && !(irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)) || (op_div_reg && div_complete && pipe2_valid);
	assign HI_wen = (op_mul_last_reg && pipe3_valid) || (mthi_reg && !(irp_ip1_3 || irp_ip0_3 || irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)) || (op_div_reg && div_complete && pipe2_valid);
	...
	begin
		...
		else if((irp_time3  || irp_ip1_3 || irp_ip0_3)&& pipe3_valid)
		begin
	...
	begin
		...
		else if((irp_ip1_3 || irp_ip0_3 || irp_address_sw3|| irp_address_lw3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid)
		begin
			if(slot_or_not_reg3)
			begin
				cp0_epc <= pipe4_PC;
