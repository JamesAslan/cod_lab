...
module mycpu_top(
	...
	begin
		...
		else if((irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3 || ((pipe2_data_in[31:26] == 6'b010000) && (pipe2_data_in[25] == 1'b1) && (pipe2_data_in[24:6] == 19'b0) &&(pipe2_data_in[5:0] == `ERET))) && pipe3_valid)
		begin
			pipe1_valid <= 1'b0;
		end
	...
	begin
		...
		else if((irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid)
		begin
			pipe2_valid <= 1'b0;
		end
		...
		begin
			...
			op_mul_reg <= (op_mul && !(irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3));
			mul_signed_reg <= mul_signed;
			op_div_reg <= (op_div && !(irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3));//////////////////////////////////////////////?????????????????????????????????????
	...
	begin
		...
		else if(irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3)
		begin
			pipe4_valid <= 1'b0;
		end
	...
	reg	 irp_ip6_reg;
	reg	 irp_ip7_reg;
	assign irp_ip = {cp0_cause_ip7,cp0_cause_ip6,cp0_cause_ip5,cp0_cause_ip4,cp0_cause_ip3,cp0_cause_ip2,cp0_cause_ip1,cp0_cause_ip0} & cp0_status_im;
	...
	assign PC = ((irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid) ? 32'hbfc00380 :
...
assign Write_data =		({32{mem_sb}} & sb_data) |
	...
	assign LO_wen = (op_mul_last_reg && pipe3_valid) || (mtlo_reg && !(irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)) || (op_div_reg && div_complete && pipe2_valid);
	assign HI_wen = (op_mul_last_reg && pipe3_valid) || (mthi_reg && !(irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)) || (op_div_reg && div_complete && pipe2_valid);
	...
	begin
		...
		else if(irp_support3)
		begin
			cp0_cause_exccode	<= 5'h0a;
		end
		else if (irp_inst3 || irp_address_lw3)
		begin
			cp0_cause_exccode	<= 5'h04;
		end
		else if (irp_address_sw3)
		begin
	...
	begin
		...
		begin
			cp0_cause_bd	<= ((irp_address_sw3 || irp_address_lw3 || irp_inst3 || irp_support3 || irp_time3 || irp_overflow3 || break_info3 || syscall_info3)&& pipe3_valid) && slot_or_not_reg3;
		end
	end
